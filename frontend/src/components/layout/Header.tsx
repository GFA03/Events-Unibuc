    ...
    return (
        <header
            ...
            <nav className="container mx-auto px-4 py-3 flex justify-between items-center">
                <Link href="/">
                    <Image src={"/unibuc-logo.webp"} alt={"Universitatea Bucuresti Evenimente"} width={100} height={100} priority={true}
                ...
                <div className="flex items-center space-x-4">
                    ...
                    {isLoading ? (
                        ...
                        <>
                            ...
                            <span
                                className="text-sm text-gray-700 hidden sm:block">Hi, {user?.firstName || user?.email}</span>
